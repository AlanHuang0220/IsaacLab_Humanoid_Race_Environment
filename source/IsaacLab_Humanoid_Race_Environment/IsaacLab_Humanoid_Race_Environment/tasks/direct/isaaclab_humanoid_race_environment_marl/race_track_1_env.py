...
from isaaclab.sensors import ContactSensor, RayCaster, ContactSensorCfg
...
class RaceTrack1Env(DirectMARLEnv):
    ...
    def _setup_scene(self):
        # create assets
        cfg = sim_utils.UsdFileCfg(usd_path=f"../source/IsaacLab_Humanoid_Race_Environment/IsaacLab_Humanoid_Race_Environment/tasks/direct/isaaclab_humanoid_race_environment_marl/aseets/running_track1.usd")
