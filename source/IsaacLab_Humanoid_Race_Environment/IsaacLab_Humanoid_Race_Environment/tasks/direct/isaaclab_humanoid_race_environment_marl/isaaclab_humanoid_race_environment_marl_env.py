...
from .isaaclab_humanoid_race_environment_marl_env_cfg import IsaaclabHumanoidRaceEnvironmentMarlEnvCfg


class IsaaclabHumanoidRaceEnvironmentMarlEnv(DirectMARLEnv):
    cfg: IsaaclabHumanoidRaceEnvironmentMarlEnvCfg

    def __init__(self, cfg: IsaaclabHumanoidRaceEnvironmentMarlEnvCfg, render_mode: str | None = None, **kwargs):
