...
@configclass
class RaceTrack1EnvCfg(DirectMARLEnvCfg):
    def __post_init__(self):
        ...
        self.ground_cfg = AssetBaseCfg(
            ...
            spawn=sim_utils.UsdFileCfg(
                usd_path=f"D:/RL2025/IsaacLab_Humanoid_Race_Environment/source/IsaacLab_Humanoid_Race_Environment/IsaacLab_Humanoid_Race_Environment/tasks/direct/isaaclab_humanoid_race_environment_marl/aseets/runing_track.usd",
                scale=(1, 1, 1),
            ),
        )
        ...
        for i in range(1, num_robots + 1):
            ...
            height_scanner_cfg = RayCasterCfg(
                ...
                # /World/ground/flat_plane/GroundPlane/CollisionMesh
                # /World/ground/slope/Stairs/Cube
